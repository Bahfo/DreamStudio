...
def open_settings_window():
    ...
    accessibility_frame = ctk.CTkFrame(scrollable_frame, corner_radius=8)
    ...
    high_contrast_switch = ctk.CTkSwitch(accessibility_frame, text="")
    ...
    appearance_frame = ctk.CTkFrame(scrollable_frame, corner_radius=8)
    ...
    accent_combo = ctk.CTkComboBox(
        ...
        variable=accent_var,
        command=lambda value: ctk.set_default_color_theme(
    ...
    editor_frame = ctk.CTkFrame(scrollable_frame, corner_radius=8)
    ...
    tab_size_slider.grid(
        row=2, column=0, columnspan=2, padx=20, pady=(0, 15), sticky="ew"
    )
    ...
    spaces_switch = ctk.CTkSwitch(editor_frame, text="")
    ...
    auto_save_switch = ctk.CTkSwitch(editor_frame, text="")
    ...
    files_frame = ctk.CTkFrame(scrollable_frame, corner_radius=8)
    ...
    trusted_workspaces_allow = ctk.CTkSwitch(
        files_frame, text="", button_color="#361E1E", button_hover_color="#ffffff"
    )
    ...
    workspace_entry = ctk.CTkEntry(
        files_frame, placeholder_text=f"C:/Users/{os.getlogin()}/Documents", width=300
    )
