...
class PromptXHighlighter(QSyntaxHighlighter):
    ...
    def retheme(self, colors: dict) -> None:
        self._error_fmt.setForeground(QColor(colors.get("error", "#FF5252")))
        self._cmd_fmt.setForeground(QColor(colors.get("command", "#FFD740")))
        self._num_fmt.setForeground(QColor(colors.get("number", "#69F0AE")))
        self._success_fmt.setForeground(QColor(colors.get("success", "#40C4FF")))
        self._prompt_fmt.setForeground(QColor(colors.get("prompt", "#888888")))
        self.rehighlight()
