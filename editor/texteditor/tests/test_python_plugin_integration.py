...
from editor.texteditor.language_engine import LanguageRegistry, BaseLanguageProvider
...
class TestPluginRegistration:
    ...
    def test_unregister_python_language(self):
        from editor.texteditor.plugins.registration import (
            register_python_language,
    ...
    def test_unregister_returns_false_when_not_registered(self):
        from editor.texteditor.plugins.registration import unregister_python_language
...
class TestEditorIntegration:
    ...
    def test_editor_clears_provider_on_empty_language(self, qapp_instance, language_registry):
        from editor.texteditor.code_editor import CodeEditor
...
class TestPluginModuleImports:
    ...
    def test_import_interfaces(self):
        from editor.texteditor.plugins.python.interfaces import (
            IJediAdapter,
            INavigationService,
    ...
    def test_import_package_init(self):
        from editor.texteditor.plugins.python import (
