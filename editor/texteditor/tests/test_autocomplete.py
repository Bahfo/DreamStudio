...
class TestCompletionItem:
    ...
    def test_creation(self):
        from editor.texteditor.autocomplete_menu import CompletionItem
...
class TestCompletionModel:
    ...
    def test_empty_model(self):
        from editor.texteditor.autocomplete_menu import CompletionModel
    ...
    def test_set_items(self):
        from editor.texteditor.autocomplete_menu import CompletionModel, CompletionItem
...
class TestIntelliSenseMenu:
    ...
    def test_menu_creation(self, qapp_instance):
        from editor.texteditor.autocomplete_menu import IntelliSenseMenu
