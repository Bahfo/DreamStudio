...
class CTkScrollableFrame(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    def __init__(self,
        ...
        self._parent_canvas.bind_all("<MouseWheel>", self._mouse_wheel_all)
        # Linux support
        self._parent_canvas.bind_all("<Button-4>", self._mouse_wheel_all)
        self._parent_canvas.bind_all("<Button-5>", self._mouse_wheel_all)
