...
assembly = Image.open("icons/types/asm.png")
bsharp = Image.open("icons/types/b_sharp.png")
binary = Image.open("icons/types/bin.png")
c_f = Image.open("icons/types/c.ico")
cmake = Image.open("icons/types/cmake.png")
cpp = Image.open("icons/types/cpp.png")
csv = Image.open("icons/types/csv.png")
c_sharp = Image.open("icons/types/csharp.ico")
css = Image.open("icons/types/css.png")
d_ = Image.open("icons/types/d.png")
docker = Image.open("icons/types/docker.png")
flutter = Image.open("icons/types/flutter.png")
fsharp = Image.open("icons/types/fsharp.png")
folder = Image.open("icons/types/folder.png")
git = Image.open("icons/types/git.png")
go = Image.open("icons/types/go.png")
html_ = Image.open("icons/types/html.png")
ipynb = Image.open("icons/types/ipynb.png")
javascript = Image.open("icons/types/javascript.ico")
jpeg = Image.open("icons/types/jpeg.png")
md = Image.open("icons/types/md.png")
pdf = Image.open("icons/types/pdf.png")
pycache = Image.open("icons/types/pyc.png")
python = Image.open("icons/types/python.ico")
rar = Image.open("icons/types/rar.png")
ruby = Image.open("icons/types/ruby.ico")
rust = Image.open("icons/types/rust.ico")
shell = Image.open("icons/types/shell.png")
swift = Image.open("icons/types/swift.ico")
typescript = Image.open("icons/types/typescript.ico")
vb = Image.open("icons/types/vb.png")
vs = Image.open("icons/types/vs.png")
vscode = Image.open("icons/types/vscode.png")
default = Image.open("icons/types/file.png")
