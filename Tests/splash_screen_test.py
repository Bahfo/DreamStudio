...
class VSCodeIDE:
    ...
    def create_menu(self):
        ...
        run_menu.add_command(label="Run in Terminal", command=self.run_in_terminal, accelerator="F5")
    ...
    def create_terminal(self):
        ...
        self.terminal = scrolledtext.ScrolledText(self.terminal_frame, height=10, wrap=tk.WORD)
    ...
    def execute_command(self, cmd):
        try:
            ...
            process.wait()
            print(f"Process finished with return code: {process.returncode}")  # Debug print
    ...
    def check_output_queue(self):
        ...
        try:
            ...
            pass
        self.root.after(50, self.check_output_queue)  # Check every 50ms for faster updates
